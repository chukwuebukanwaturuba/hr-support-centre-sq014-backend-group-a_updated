...
//
       ...
       Employee employee2 = employeeRepository.save(newEmployee1);
        ...
        CreateHrResponseDTO createHrResponseDTO = new CreateHrResponseDTO();
          BeanUtils.copyProperties(employee2, createHrResponseDTO);
          createHrResponseDTO.setRole(employee2.getRole().getName());
          return createHrResponseDTO;
        //return newEmployee1;
